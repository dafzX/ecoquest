      ...
      <div class="relative min-h-screen overflow-hidden lg:hidden">
        ...
        <div class="relative z-10 px-6 pb-10 pt-8">
          ...
          <div class="mt-8 text-center">
            ...
            <p class="mx-auto mt-1.5 max-w-67.5 text-[11px] leading-4 text-[#718078]">
          ...
          <form
            ...
            class="mx-auto mt-6 w-full max-w-82.5 space-y-3"
          >
            <!-- Name -->
            <div>
              <div class="relative">
            ...
            <button
              type="submit"
              class="mt-1 h-10 w-full rounded-lg bg-[#22C55E] text-[11px] font-semibold text-white transition hover:bg-[#16A34A] active:bg-[#15803D]"
            >
              Daftar
            </button>
          </form>
        ...
        <div class="pointer-events-none absolute bottom-0 left-0 right-0 h-28">
          ...
          <Leaf
            class="absolute bottom-3 left-4 h-14 w-14 -rotate-18 text-[#BFE8CC]/50"
          />

          <Leaf
            class="absolute bottom-1 right-8 h-12 w-12 rotate-22 text-[#BFE8CC]/40"
          />
        </div>
      </div>
