    ...
    <div class="mx-auto max-w-6xl px-6 py-8">
      ...
      <div class="mb-7 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-xs text-[#98A39C]">Challenges</p>
            <h1 class="text-xl font-bold text-[#17211B]">Challenge Detail</h1>
          </div>
        </div>
      </div>
        ...
        <div>
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <div class="flex h-48 w-48 items-center justify-center rounded-full bg-white/60">
                <div class="flex h-32 w-32 items-center justify-center rounded-full bg-white/80">
                  <component :is="getCategoryIcon(challenge.category)" class="h-20 w-20 text-[#22C55E]" />
                </div>
              </div>
            </div>
          ...
          <div class="mt-6">
            ...
            <div class="mt-1 flex items-center justify-between gap-5">
              <h2 class="text-3xl font-bold text-[#17211B]">{{ challenge.title }}</h2>
            </div>
        ...
        <div class="space-y-5">
          ...
          <section class="rounded-2xl border border-[#E5EEE8] bg-white p-6">
            <div class="flex items-center justify-between">
              <div>
                <h3 class="text-sm font-bold text-[#17211B]">Progress Komunitas</h3>
                <p class="mt-1 text-xs text-[#98A39C]">Mari capai target bersama!</p>
              </div>
              <div class="flex h-11 w-11 items-center justify-center rounded-full bg-[#EAF8EE]">
                <span class="text-xs font-bold text-[#15803D]">{{ challenge.progress }}%</span>
              </div>
            </div>
            ...
            <div class="mt-3 flex justify-between text-xs">
              <span class="text-[#98A39C]">{{ challenge.daysLeft }} hari lagi</span>
              <span class="font-medium text-[#15803D]">{{ challenge.progress }}% selesai</span>
            </div>
          </section>
          ...
          <section class="rounded-2xl bg-[#17211B] p-5">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-xs text-white/50">Challenge Reward</p>
                <div class="mt-1 flex items-center gap-2">
                  <span class="text-base font-bold text-white">Special Badge & 500 XP</span>
                </div>
              </div>
